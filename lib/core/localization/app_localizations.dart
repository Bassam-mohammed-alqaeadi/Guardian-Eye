...
'aiHubRiskTitle': 'مستويات المخاطر',
    ...
    'aiRiskEmptyNote': 'يحتاج محرك المخاطر إلى بضعة أيام من الإشارات قبل أن يقيّم. لا نقدّر شيئاً من العدم.',
    'aiRiskObservationOnly': 'هذه ملاحظات وليست إجراءات. الإنفاذ يتم فقط عبر قواعد عائلتك.',
    ...
    'aiInsightStableWeekBody': 'بقيت الإشارات ضمن أساس العائلة. لم نلاحظ تغيراً ملحوظاً.',
    'aiInsightNightUsageUp': 'ارتفاع الاستخدام الليلي',
    'aiInsightNightUsageUpBody': 'تجاوزت الجلسات الليلية نافذة الأساس. يستحق مراجعة روتين النوم.',
    'aiInsightIncidentsUp': 'زيادة الحوادث',
    'aiInsightIncidentsUpBody': 'تنبيهات أكثر من النافذة السابقة. راجع شاشات الموقع والحوادث للتفاصيل.',
    'aiInsightInsufficientData': 'بيانات غير كافية',
    'aiInsightInsufficientDataNote': 'إشارات قليلة هذه الفترة لإنتاج رؤية صادقة.',
    'aiFailClosedNote': 'لا يوجد نموذج محلي مُهيّأ، لذا يعمل الذكاء بالقواعد الحتمية فقط ويصرّح بذلك بصدق.',
    'aiModelNoneNote': 'إصدار النموذج "لا شيء" — قواعد حتمية فقط، لم يُطبَّق أي تعلّم آلي.',
    ...
    'aiPolicyNeverSelfApply': 'الاقتراحات لا تطبّق نفسها أبداً. يجب أن يتخذ ولي الأمر إجراءً أولاً.',
    ...
    'aiProposalNightLimitRationale': 'تجاوز الاستخدام الليلي الأساس ثلاث مرات. نقترح حداً مؤقتاً عند 10 مساءً.',
    ...
    'aiPrivacyFailClosedNote': 'إذا لم يستطع الذكاء إثبات الموافقة، تُحجب الإشارة — العائلة دائماً هي الرابحة.',
    ...
    'aiExplainBodyNoChange': 'بقيت الإشارات ضمن النطاقات المتوقعة؛ لم يستدعِ الأمر تصعيداً.',
    'aiExplainNoSignals': 'لا توجد إشارات متاحة هذه الفترة.',
    'aiExplainBodyNoSignals': 'استقبل المحرك مشاهدات قليلة جداً ليشرح. نصرّح بذلك بصدق.',
    'aiExplainBodySignals': 'إشارات خارجة عن الأساس:',
    'aiExplainFallback': 'اُستخدم البديل — لا يوجد دليل موثّق يدعم هذا الشرح.',
    'coupleTitle': 'وئام الزوجين',
    'coupleHubNote': 'القرارات والروتينات وتسليم المهام بين الوالدين — كل اقتراح يحتاج رداً صريحاً.',
    ...
    'coupleLinkingLinkedNote': 'أنتم مرتبطون. الوالدان يريان الاقتراحات نفسها ويمكن الرد على بعضهما.',
    'coupleLinkingNote': 'يجب أن يقبل الزوج/الزوجة الربط قبل أن تسري أي قرارات مشتركة.',
    'coupleLinkingPartnerHint': 'اضغط على فرد العائلة الذي هو زوجك/زوجتك لإرسال طلب الربط.',
    'coupleNewProposal': 'اقتراح جديد',
    'coupleNewProposalTitle': 'صياغة اقتراح',
    'coupleNewProposalHint': 'تُرسل الاقتراحات إلى زوجك/زوجتك وتنتظر رده. لا يُطبَّق شيء تلقائياً.',
    ...
    'coupleHandoverNote': 'تسلّم المهمة ينقل الإشراف على الطفل بين الوالدين. تكتمل فقط عندما يؤكّد الوالد المستقبل.',
    ...
    'subscriptionEntitlementsNote': 'كل بوابة ميزة مخزّنة محلياً وقابلة للمراجعة. لا يُخصَم شيء.',
    'subscriptionEntitlementsEmpty': 'لا توجد سجلات تفويض بعد.',
    'subscriptionMeters': 'عدادات الاستخدام',
    'subscriptionMetersNote': 'عدادات استخدام صادقة — لا يلفّق التطبيق حصّة متبقية.',
    'subscriptionMetersEmpty': 'لا توجد عدادات استخدام بعد.',
    'subscriptionBilling': 'سجلات الفوترة',
    'subscriptionBillingNote': 'سجلات فوترة محلية فقط. لا يوجد معالج مدفوعات مدمج.',
    ...
    'subscriptionPaywallNote': 'جدار دفع صادق: اختيار خطة يسجّل قرار منح محلياً من المالك. لا يُخصَم مال، ولا يوجد معالج مدفوعات مدمج.',
    ...
    'weekdaySunday': 'الأحد',
      ...
      'exportPermissionDenied': 'يمكن للأعضاء البالغين المفعّلين فقط تصدير بيانات الأسرة.',
      'exportScopeTitle': 'ماذا يُصدَّر محليًا؟',
      'exportScopeIncluded': 'ملف JSON موثّق إصداريًا يحتوي بيانات الأسرة التي يراها الوالد المفعّل: الأعضاء، الأجهزة، إعدادات الموقع، نقاط الموقع مجمّعة، الأسوار الجغرافية، الأماكن المفضلة، الحوادث، أحداث الطوارئ، فلاتر الويب، الاستخدام، الأوضاع، القواعد، المهام، المكافآت، الروابط الزوجية، والاشتراك.',
      'exportScopeExcluded': 'لا يُصدَّر أبدًا: رموز الإشعارات (FCM)، سجلّ الانتظار غير المُسلَّم، هويات التطبيق، وبيانات الذكاء الاصطناعي المجمّدة. هذا مضمون بالتصميم ويُتحقَّق منه قبل أي مشاركة.',
      ...
      'exportReadyDetail': 'ملف JSON محلي تم التحقق من صحته وسلامته. بيانات السحابة لم تُمس.',
      'exportSharedDetail': 'شارك الملف بحذر — فهو يحتوي بيانات أسرتك المحلية.',
      'exportFailedDetail': 'لم يُكتَب أي ملف. أعد المحاولة أو راجع الحالة أدناه.',
      'exportBlockedDetail': 'هذا الحساب ليس عضوًا بالغًا مفعّلًا في هذه الأسرة.',
      ...
      'chatEmptyHint': 'ابدأ محادثة أسرية أو خاصة. الرسائل تختفي تلقائيًا بعد 24 ساعة.',
      'chatLastMessage': 'آخر رسالة',
      'chatExpiration24h': 'تختفي بعد 24 ساعة',
      'chatExpirationNotice': 'الرسائل في هذه المحادثة تُحذف تلقائيًا بعد 24 ساعة من إرسالها.',
      'chatExpiredTitle': 'انتهت صلاحية المحادثة',
      'chatExpiredBody': 'هذه المحادثة لا تحوي أي رسائل نشطة بعد انتهاء صلاحيتها. تظهر هنا فقط لأنك شاركت فيها.',
      ...
      'purgeBillingRetention90Days': 'سجلات الاشتراك تُحفظ محليًا لمدة 90 يومًا لأغراض الفوترة.',
      'purgeCancel': 'إلغاء',
      'purgeCompletedDetail': 'حُذفت بيانات هذا الجهاز محليًا. السجلات المحجوزة باقية كما وُضِّح.',
      'purgeConfirm': 'حذف نهائيًا',
      'purgeConfirmationBody': 'سيُحذف نهائيًا من هذا الجهاز جميع بيانات الأسرة المحلية باستثناء سجلات السلامة وسجلات الدفع المحجوزة لمدة 90 يومًا. لا يمكن التراجع عن هذه العملية على هذا الجهاز.',
      'purgeConfirmationTitle': 'حذف البيانات المحلية؟',
      'purgeFailedDetail': 'لم يُحذف أي شيء. بياناتك محفوظة كما هي.',
      'purgeMigrationBlockedDetail': 'لا يمكن الحذف على قاعدة بيانات قديمة غير مؤهلة. حدّث التطبيق أولًا.',
      'purgeOutboxAbandoned': 'طابور المزامنة المهجور يُترك كما هو — تتوقف عملياته ولا تُرسل بعد الآن.',
      'purgePartiallyCompletedDetail': 'حُذفت بعض البيانات وأُبقي على الأخرى. لا يمكن إعادة المحاولة الآن.',
      'purgePermissionDenied': 'غير مسموح بالحذف الآن',
      'purgePermissionDeniedDetail': 'الأطفال لا يُسمح لهم بحذف بيانات الأسرة. يلزم دور أب أو زوج.',
      'purgeRemoteDataRemains': 'البيانات السحابية تبقى كما هي.',
      'purgeRemoteDataRemainsDetail': 'هذا الإجراء يخص هذا الجهاز فقط. لا يحذف أي بيانات من Firebase أو الخوادم.',
      'purgeRetentionTitle': 'ما الذي يُبقى محفوظًا؟',
      'purgeSafetyRecordsRetained': 'سجلات السلامة (حوادث SOS ونتائج الإشراف) تُبقى محليًا لأغراض قانونية وأمنية.',
      ...
      'splashErrorNote': 'التطبيق محلي بالكامل حتى يتوفر الاتصال أو إعداد Firebase.',
      ...
      'roleGateHeroNote': 'اختيارك يستند إلى عضويتك المحقّقة في العائلة، ولا يُمنح أي دور افتراضيًا.',
      'roleGatePersistNote': 'يُحفظ الدور محليًا على هذا الجهاز فقط ويُعاد التحقق عند تغيير عضويتك.',
      'roleGateEntering': 'جارٍ الدخول…',
      'roleGateUnverifiedTitle': 'لا يمكن التحقق من العائلة',
      'roleGateUnverifiedDetail': 'تعذّر التحقق من عضويتك. لا يُمنح أي دور دون تحقق حقيقي.',
      'roleGateUnverifiedRecover': 'لإصلاح ذلك، تأكد من وجودك في عائلة نشطة أو أعد ربط جهازك.',
      'roleGateSignedOutTitle': 'مرحبًا بك',
      'roleGateSignedOutDetail': 'سجّل الدخول أولًا حتى نحدد عضويتك العائلية بأمان.',
      ...
      'whatsNewCurrentDetail': 'عرض إصدار جديد لكل تغيير منشور مع حالة مزامنة صادقة.',
      'whatsNewZeroNineTitle': 'الدفعات التأسيسية',
      'whatsNewZeroNineDetail': 'الخريطة، القواعد العائلية، التقارير، المهام والمكافآت، والمزامنة الخلفية.',
      ...
      'whatsNewOfflineBody': 'بطاقات المزامنة تُحدَّث عند عودة الاتصال. التطبيق يعمل محليًا أثناء الانقطاع.',
      ...
      'firebaseAuthFailed': 'تعذّر التحقق. تحقق من البريد الإلكتروني وكلمة المرور.',
      ...
      'firebaseUnconfiguredBody': 'يبقى التطبيق محليًا بلا اتصال. لا يمكن تسجيل الدخول أو مزامنة البيانات حتى يُضاف إعداد Firebase المعتمد من مالك المشروع.',
      ...
      'firebaseProjectNote': 'هذا التدفق فقط لإعداد Firebase الذي يملكه المشروع.',
      'firebaseContinueAnonymous': 'المتابعة بجلسة مؤقتة',
      'firebaseAnonymousNote': 'الجلسة المؤقتة ليست حساب والد ولا تمنح عضوية أو صلاحيات عائلية.',
      ...
      'firebaseAuthReadErrorBody': 'حاول مرة أخرى بعد التحقق من إعداد Firebase.',
      ...
      'familyJoinPathNote': 'أدخل الرمز المكون من 6 أرقام الذي شاركه معك ولي الأمر الرئيسي.',
      'familyCreatePathTitle': 'إنشاء عائلة جديدة',
      'familyCreatePathNote': 'ابدأ بصفتك ولي الأمر الرئيسي وأنشئ مساحة آمنة لعائلتك.',
...
'aiHubRiskTitle': 'Risk levels',
    ...
    'aiRiskEmptyNote': 'The risk engine needs a few days of signals before it can evaluate. Nothing is estimated.',
    'aiRiskObservationOnly': 'These are observations, not actions. Enforcement is only handled by your family rules.',
    ...
    'aiInsightStableWeekBody': 'Signals stayed within the family baseline. No notable change was observed.',
    'aiInsightNightUsageUp': 'Night usage rose',
    'aiInsightNightUsageUpBody': 'Night-time sessions exceeded the baseline window. Worth reviewing bedtime routines.',
    'aiInsightIncidentsUp': 'Incidents increased',
    'aiInsightIncidentsUpBody': 'More alerts than the previous window. Check the location and incidents views for details.',
    'aiInsightInsufficientData': 'Not enough data',
    'aiInsightInsufficientDataNote': 'Too few signals this period to compute an honest insight.',
    'aiFailClosedNote': 'No on-device model is configured, so intelligence runs deterministic-only and discloses that honestly.',
    'aiModelNoneNote': 'Model version "none" — deterministic rules only, no machine learning was applied.',
    ...
    'aiPolicyNeverSelfApply': 'Proposals never apply themselves. A parent must act first.',
    ...
    'aiProposalNightLimitRationale': 'Night usage has exceeded the baseline three times. A temporary 10 PM cutoff is proposed.',
    ...
    'aiPrivacyFailClosedNote': 'If the AI cannot prove consent, the signal is blocked — the family always wins.',
    ...
    'aiExplainBodyNoChange': 'Signals stayed within expected ranges; nothing required escalation.',
    'aiExplainNoSignals': 'No signals available this period.',
    'aiExplainBodyNoSignals': 'The engine received too few observations to explain. This is stated honestly.',
    'aiExplainBodySignals': 'Signals outside the baseline:',
    'aiExplainFallback': 'Fallback used — no verified evidence supports this explanation.',
    'coupleTitle': 'Couple Harmony',
    'coupleHubNote': 'Decisions, routines and handovers between parents — every proposal needs an explicit reply.',
    ...
    'coupleLinkingLinkedNote': 'You are linked. Both parents see the same proposals and can respond to each other.',
    'coupleLinkingNote': 'The spouse must accept the link before any shared decisions take effect.',
    'coupleLinkingPartnerHint': 'Tap the family member who is your spouse to send a linking request.',
    'coupleNewProposal': 'New proposal',
    'coupleNewProposalTitle': 'Draft a proposal',
    'coupleNewProposalHint': 'Proposals are sent to your spouse and wait for their reply. Nothing applies automatically.',
    ...
    'coupleProposalInboxNote': 'Proposals from your spouse waiting for your reply.',
    'coupleProposalNote': 'Every proposal records who proposed it and the exact time of each reply.',
    ...
    'coupleHandoverNote': 'A handover transfers supervision of a child between parents. It completes only when the receiving parent confirms.',
    ...
    'subscriptionEntitlementsNote': 'Every feature gate is stored locally and auditable. Nothing is charged.',
    'subscriptionEntitlementsEmpty': 'No entitlement records yet.',
    'subscriptionMeters': 'Usage meters',
    'subscriptionMetersNote': 'Honest usage counters — the app never fabricates remaining quota.',
    'subscriptionMetersEmpty': 'No usage meters yet.',
    'subscriptionBilling': 'Billing records',
    'subscriptionBillingNote': 'Local billing records only. No payment processor is integrated.',
    ...
    'subscriptionLockedMessage': 'Only the family owner can manage the subscription.',
    'subscriptionOverLimit': 'One or more usage meters is over its limit.',
    'subscriptionTiers': 'Available tiers',
    'subscriptionPaywallNote': 'Honest paywall: selecting a tier records a local grant decision by the owner. No money is taken, no payment processor is integrated.',
    ...
    'weekdaySunday': 'Sunday',
      ...
      'exportPermissionDenied': 'Only active adult members may export family data.',
      'exportScopeTitle': 'What is exported locally?',
      'exportScopeIncluded': 'A versioned, schema-validated JSON file of the data an active parent can already see: members, devices, location settings, aggregated location points, geofences, favorite places, incidents, SOS events, web filtering stats, usage stats, modes, family rules, tasks, rewards, couple linking, and subscription.',
      'exportScopeExcluded': 'Never exported: FCM notification tokens, undelivered outbox, app identity, and the frozen AI tables. Excluded by construction and re-validated before any file is ever shared.',
      ...
      'exportReadyDetail': 'A validated local JSON file. Cloud data was never touched.',
      'exportSharedDetail': 'Share carefully — the file contains your local family data.',
      'exportFailedDetail': 'No file was written. Retry or check the reason below.',
      'exportBlockedDetail': 'This account is not an active adult member of this family.',
      'exportLocalOnly': 'Export is local only.',
      'exportLocalOnlyDetail': 'The export file is never uploaded to any server automatically.',
      ...
      'chatEmptyHint': 'Start a family or private chat. Messages disappear automatically after 24 hours.',
      'chatLastMessage': 'Last message',
      'chatExpiration24h': 'Disappears after 24 hours',
      'chatExpirationNotice': 'Messages in this chat are deleted automatically 24 hours after sending.',
      'chatExpiredTitle': 'Chat expired',
      'chatExpiredBody': 'This chat holds no active messages after expiry. It is shown only because you took part in it.',
      ...
      'chatOfflineHint': 'Offline messages are sent automatically when the network returns.',
      'chatFailedBanner': 'Could not open chats',
      'privacyTitle': 'Privacy',
      'purgeBillingRetention90Days': 'Subscription records are held locally for 90 days for billing purposes.',
      'purgeCancel': 'Cancel',
      'purgeCompletedDetail': 'This device\'s local data was deleted. Retained records stay as described.',
      'purgeConfirm': 'Delete permanently',
      'purgeConfirmationBody': 'This permanently deletes all local family data on this device, except retained safety records and the 90-day billing hold. This action cannot be undone on this device.',
      'purgeConfirmationTitle': 'Delete local data?',
      'purgeFailedDetail': 'Nothing was deleted. Your data remains safe.',
      'purgeMigrationBlockedDetail': 'Purge is unavailable on a legacy database that could not be brought up to date. Update the app first.',
      'purgeOutboxAbandoned': 'The sync queue is abandoned — its operations stop and are never sent again.',
      'purgePartiallyCompletedDetail': 'Some data was deleted and some was retained. It cannot be retried now.',
      'purgePermissionDenied': 'Purge is not allowed right now',
      'purgePermissionDeniedDetail': 'Children cannot delete family data. A parent or spouse role is required.',
      'purgeRemoteDataRemains': 'Cloud data remains untouched.',
      'purgeRemoteDataRemainsDetail': 'This action applies only to this device. It does not delete any data from Firebase or servers.',
      'purgeRetentionTitle': 'What is retained?',
      'purgeSafetyRecordsRetained': 'Safety records (SOS incidents and enforcement outcomes) are retained locally for legal and safety purposes.',
      ...
      'splashErrorNote': 'The app runs fully local until Firebase is configured or connectivity returns.',
      'splashOfflineNote': 'Offline mode shows automatically when the network drops.',
      'startupErrorNote': 'Verification failed. The app keeps running locally.',
      'startupFreshnessTitle': 'Sync status',
      'startupFreshnessPending': 'Not synced yet — it will sync when connectivity allows.',
      ...
      'roleGateHeroNote': 'Your choice is derived from your verified family membership — no role is ever granted by default.',
      'roleGatePersistNote': 'The role is stored locally on this device only and re-verified if membership changes.',
      'roleGateEntering': 'Entering…',
      'roleGateUnverifiedTitle': 'Family cannot be verified',
      'roleGateUnverifiedDetail': 'Your membership could not be verified. No role is granted without real verification.',
      'roleGateUnverifiedRecover': 'To recover, make sure you belong to an active family or re-link this device.',
      'roleGateSignedOutTitle': 'Welcome',
      'roleGateSignedOutDetail': 'Sign in first so your family membership can be resolved safely.',
      ...
      'whatsNewCurrentDetail': 'A versioned release note for every published change, with an honest sync status card.',
      'whatsNewZeroNineTitle': 'Foundational batches',
      'whatsNewZeroNineDetail': 'Map, family rules, reports, tasks & rewards, and background sync.',
      'whatsNewAllCaughtUpTitle': 'Nothing new',
      'whatsNewAllCaughtUpDetail': 'You are up to date with every published change.',
      'whatsNewEmptyBody': 'No published updates yet.',
      'whatsNewVersionLabel': 'Version',
      'whatsNewDismiss': 'Viewed',
      'whatsNewOfflineTitle': 'Offline',
      'whatsNewOfflineBody': 'Sync cards refresh when connectivity returns. The app keeps running locally while offline.',
      ...
      'firebaseAuthFailed': 'Authentication failed. Check your email and password.',
      ...
      'firebaseUnconfiguredBody': 'The app stays local and offline. No sign-in or data sync is possible until the project owner adds approved Firebase configuration.',
      ...
      'firebaseProjectNote': 'This flow is only for Firebase owned by the project.',
      'firebaseContinueAnonymous': 'Continue with a temporary session',
      'firebaseAnonymousNote': 'A temporary session is not a parent account and grants no family membership or permissions.',
      ...
      'firebaseAuthReadErrorBody': 'Try again after checking the Firebase configuration.',
      ...
      'familyJoinPathNote': 'Enter the 6-digit code shared by your primary parent.',
      'familyCreatePathTitle': 'Create a new family',
      'familyCreatePathNote': 'Start as a primary parent and build a safe space for your family.',
